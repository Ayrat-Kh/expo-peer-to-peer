...
const StyledSvg = styled(Svg, 'stroke-primary');
...
export const ConnectIcon: React.FC<ConnectIconProps> = ({ size, style }) => {
  return (
    <StyledSvg style={style} width={size} height={size} viewBox="0 0 24 24">
      <Path
